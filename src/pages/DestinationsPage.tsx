...
const DESTINATIONS = [
  ...
  { slug: 'serengeti',     name: 'Serengeti',     country: 'Tanzania',       region: 'Africa'      as Region, tags: ['Wildlife', 'Adventure', 'Nature'],    flag: '🇹🇿', stats: '85 Lodges · 12 Safaris',    imageUrl: 'https://images.unsplash.com/photo-1516426122078-c23e76319801?w=1400&auto=format&fit=crop&q=85', themeColor: '35 70% 30%',  lat: -4.9000,   lng: 34.8000   },
  { slug: 'greek-islands', name: 'Greek Islands', country: 'Greece',         region: 'Europe'      as Region, tags: ['Romance', 'Beach', 'Culture'],        flag: '🇬🇷', stats: '210+ Villas · 24 Packages', imageUrl: 'https://images.unsplash.com/photo-1570077188670-e3a8d69ac5ff?w=1400&auto=format&fit=crop&q=85', themeColor: '200 70% 28%', lat: 37.0000,   lng: 25.0000   },
  { slug: 'dubai',         name: 'Dubai',         country: 'UAE',            region: 'Middle East' as Region, tags: ['Luxury', 'Architecture', 'Shopping'], flag: '🇦🇪', stats: '520+ Hotels · 32 Packages', imageUrl: 'https://images.unsplash.com/photo-1512453979798-5ea266f8880c?w=1400&auto=format&fit=crop&q=85', themeColor: '38 55% 28%',  lat: 25.2048,   lng: 55.2708   },
  { slug: 'london',        name: 'London',        country: 'United Kingdom', region: 'Europe'      as Region, tags: ['Urban', 'Culture', 'History'],        flag: '🇬🇧', stats: '890+ Hotels · 28 Packages', imageUrl: 'https://images.unsplash.com/photo-1513635269975-59663e0ac1ad?w=1400&auto=format&fit=crop&q=85', themeColor: '215 55% 20%', lat: 51.5074,   lng: -0.1276   },
  { slug: 'new-york',      name: 'New York',      country: 'United States',  region: 'Americas'    as Region, tags: ['Urban', 'Culture', 'Food'],           flag: '🇺🇸', stats: '740+ Hotels · 22 Packages', imageUrl: 'https://images.unsplash.com/photo-1496442226666-8d4d0e62e6e9?w=1400&auto=format&fit=crop&q=85', themeColor: '240 50% 22%', lat: 40.7128,   lng: -74.0060  },
