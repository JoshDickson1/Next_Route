...
const DESTINATIONS: Record<string, DestinationData> = {
  rome: {
    ...
    heroImage:   'https://images.unsplash.com/photo-1552832230-c0197dd311b5?w=1000&auto=format&fit=crop&q=80',
    ...
    gallery: [
      { id: 1, title: 'Colosseum at Dusk',   desc: 'Rome\'s iconic amphitheatre bathed in golden light',     url: 'https://images.unsplash.com/photo-1552832230-c0197dd311b5?w=600&q=75',  span: 'md:col-span-2 md:row-span-2' },
      { id: 2, title: 'Trevi Fountain',      desc: 'Baroque masterpiece in the heart of Rome',               url: 'https://images.unsplash.com/photo-1529260830199-42c24126f198?w=600&q=75', span: '' },
      { id: 3, title: 'Vatican Dome',        desc: 'Michelangelo\'s magnificent St. Peter\'s Basilica',       url: 'https://images.unsplash.com/photo-1587555049481-3aecbc1a0783?w=600&q=75', span: '' },
      { id: 4, title: 'Roman Street',        desc: 'Sunlit cobblestones of Trastevere',                       url: 'https://images.unsplash.com/photo-1519077930-d37c67943b0e?w=600&q=75', span: 'md:row-span-2' },
      { id: 5, title: 'Roman Cuisine',       desc: 'Cacio e pepe — the soul of Roman cooking',                url: 'https://images.unsplash.com/photo-1555396273-367ea4eb4db5?w=600&q=75', span: '' },
      { id: 6, title: 'Piazza Navona',       desc: 'The beating heart of baroque Rome',                       url: 'https://images.unsplash.com/photo-1600854964509-fe82ce40b4b3?w=600&q=75', span: 'md:col-span-2' },
    ],
  ...
  serengeti: {
    ...
    heroImage:   'https://images.unsplash.com/photo-1516426122078-c23e76319801?w=1000&auto=format&fit=crop&q=80',
    ...
    gallery: [
      { id: 1, title: 'The Great Migration', desc: 'Thousands of wildebeest on the move', url: 'https://images.unsplash.com/photo-1516426122078-c23e76319801?w=600&q=75', span: 'md:col-span-2 md:row-span-2' },
      { id: 2, title: 'Lion at Dawn',        desc: 'King of the plains at golden hour',   url: 'https://images.unsplash.com/photo-1546182990-dffeafbe841d?w=600&q=75',      span: '' },
      { id: 3, title: 'Elephant Herd',       desc: 'Family group crossing the savanna',   url: 'https://images.unsplash.com/photo-1564760055775-d63b17a55c44?w=600&q=75',  span: '' },
      { id: 4, title: 'Giraffe Silhouette',  desc: 'Iconic silhouette at sunset',          url: 'https://images.unsplash.com/photo-1547970810-dc1eac37d174?w=600&q=75',      span: 'md:row-span-2' },
      { id: 5, title: 'Acacia Sunrise',      desc: 'The Serengeti at its most magical',    url: 'https://images.unsplash.com/photo-1474511320723-9a56873867b5?w=600&q=75',  span: '' },
      { id: 6, title: 'Balloon Safari',      desc: 'Above the plains at sunrise',          url: 'https://images.unsplash.com/photo-1521336575822-6da63fb45455?w=600&q=75',  span: 'md:col-span-2' },
    ],
  ...
  'greek-islands': {
    ...
    heroImage:   'https://images.unsplash.com/photo-1570077188670-e3a8d69ac5ff?w=1000&auto=format&fit=crop&q=80',
    ...
    gallery: [
      { id: 1, title: 'Santorini Caldera',  desc: 'The iconic view from Oia',              url: 'https://images.unsplash.com/photo-1570077188670-e3a8d69ac5ff?w=600&q=75', span: 'md:col-span-2 md:row-span-2' },
      { id: 2, title: 'Blue Domes',         desc: 'Symbol of the Greek Islands',            url: 'https://images.unsplash.com/photo-1533105079780-92b9be482077?w=600&q=75', span: '' },
      { id: 3, title: 'Aegean Waters',      desc: 'Crystal clear coves of Mykonos',         url: 'https://images.unsplash.com/photo-1555993539-1732b0258235?w=600&q=75',     span: '' },
      { id: 4, title: 'Sunset Cruise',      desc: 'Golden hour on the Aegean Sea',           url: 'https://images.unsplash.com/photo-1601581875309-fafbf2d3ed3a?w=600&q=75', span: 'md:row-span-2' },
      { id: 5, title: 'Greek Cuisine',      desc: 'Fresh seafood at a harbour taverna',      url: 'https://images.unsplash.com/photo-1544025162-d76694265947?w=600&q=75',     span: '' },
      { id: 6, title: 'Windmills of Mykonos', desc: 'Iconic landmark at the water\'s edge', url: 'https://images.unsplash.com/photo-1603565816030-6b389eeb23cb?w=600&q=75', span: 'md:col-span-2' },
    ],
  ...
  dubai: {
    ...
    heroImage:   'https://images.unsplash.com/photo-1512453979798-5ea266f8880c?w=1000&auto=format&fit=crop&q=80',
    ...
    gallery: [
      { id: 1, title: 'Burj Khalifa',    desc: 'The world\'s tallest building at twilight', url: 'https://images.unsplash.com/photo-1512453979798-5ea266f8880c?w=600&q=75',  span: 'md:col-span-2 md:row-span-2' },
      { id: 2, title: 'Desert Safari',   desc: 'Golden dunes of the Arabian desert',         url: 'https://images.unsplash.com/photo-1509316785289-025f5b846b35?w=600&q=75',  span: '' },
      { id: 3, title: 'Dubai Marina',    desc: 'Glittering waterfront skyline at night',     url: 'https://images.unsplash.com/photo-1582672060674-bc2bd808a8b5?w=600&q=75',   span: '' },
      { id: 4, title: 'Palm Jumeirah',   desc: 'The iconic man-made island from above',       url: 'https://images.unsplash.com/photo-1585945268752-9e6c14af84e5?w=600&q=75',  span: 'md:row-span-2' },
      { id: 5, title: 'Gold Souk',       desc: 'The glittering heart of old Dubai',           url: 'https://images.unsplash.com/photo-1611273426858-450d8e3c9fce?w=600&q=75',  span: '' },
      { id: 6, title: 'Dubai Fountain',  desc: 'The world\'s largest choreographed fountain', url: 'https://images.unsplash.com/photo-1518684079-3c830dcef090?w=600&q=75',     span: 'md:col-span-2' },
    ],
    themeGradient: 'linear-gradient(135deg, #78350f 0%, #92400e 50%, #451a03 100%)',
    accentColor:   '#fbbf24',
  },
  ...
  london: {
    ...
    heroImage:   'https://images.unsplash.com/photo-1513635269975-59663e0ac1ad?w=1000&auto=format&fit=crop&q=80',
    ...
    gallery: [
      { id: 1, title: 'Tower Bridge',    desc: 'London\'s most iconic landmark',            url: 'https://images.unsplash.com/photo-1513635269975-59663e0ac1ad?w=600&q=75',  span: 'md:col-span-2 md:row-span-2' },
      { id: 2, title: 'Big Ben',         desc: 'Parliament and Westminster at twilight',     url: 'https://images.unsplash.com/photo-1543832923-44667a44c804?w=600&q=75',     span: '' },
      { id: 3, title: 'Borough Market',  desc: 'London\'s celebrated street food market',    url: 'https://images.unsplash.com/photo-1526129318478-62ed807ebdf9?w=600&q=75',  span: '' },
      { id: 4, title: 'Notting Hill',    desc: 'Colourful terraces of West London',          url: 'https://images.unsplash.com/photo-1490642914619-7955a3fd483c?w=600&q=75',  span: 'md:row-span-2' },
      { id: 5, title: 'The Shard',       desc: 'London\'s glittering glass skyline',          url: 'https://images.unsplash.com/photo-1529655683826-aba9b3e77383?w=600&q=75',  span: '' },
      { id: 6, title: 'Buckingham',     desc: 'The Changing of the Guard ceremony',          url: 'https://images.unsplash.com/photo-1604580864964-0462f5d5b1a8?w=600&q=75',  span: 'md:col-span-2' },
    ],
  ...
  'new-york': {
    ...
    heroImage:   'https://images.unsplash.com/photo-1496442226666-8d4d0e62e6e9?w=1000&auto=format&fit=crop&q=80',
    ...
    gallery: [
      { id: 1, title: 'Manhattan Skyline', desc: 'NYC from the Hudson River',             url: 'https://images.unsplash.com/photo-1496442226666-8d4d0e62e6e9?w=600&q=75', span: 'md:col-span-2 md:row-span-2' },
      { id: 2, title: 'Brooklyn Bridge',   desc: 'The iconic bridge at golden hour',       url: 'https://images.unsplash.com/photo-1555109307-f7d9da25c244?w=600&q=75',    span: '' },
      { id: 3, title: 'Central Park',      desc: 'Autumn colours in 843 acres of green',   url: 'https://images.unsplash.com/photo-1534430480872-3498386e7856?w=600&q=75', span: '' },
      { id: 4, title: 'Times Square',      desc: 'The crossroads of the world',             url: 'https://images.unsplash.com/photo-1534430480872-3498386e7856?w=600&q=75', span: 'md:row-span-2' },
      { id: 5, title: 'NYC Food Scene',    desc: 'The city\'s legendary culinary diversity', url: 'https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=600&q=75', span: '' },
      { id: 6, title: 'Empire State',      desc: 'Art Deco icon of the NYC skyline',        url: 'https://images.unsplash.com/photo-1499092346302-b8d7a599720e?w=600&q=75', span: 'md:col-span-2' },
    ],
  ...
  cartagena: {
    ...
    heroImage:   'https://images.unsplash.com/photo-1583417319070-4a69db38a482?w=1000&auto=format&fit=crop&q=80',
    ...
    gallery: [
      { id: 1, title: 'Old City Walls',   desc: 'UNESCO-listed colonial fortifications',     url: 'https://images.unsplash.com/photo-1583417319070-4a69db38a482?w=600&q=75',  span: 'md:col-span-2 md:row-span-2' },
      { id: 2, title: 'Caribbean Beach',  desc: 'Crystal waters of the Rosario Islands',     url: 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=600&q=75',   span: '' },
      { id: 3, title: 'Colonial Streets', desc: 'Cartagena\'s signature colourful facades',   url: 'https://images.unsplash.com/photo-1574871786514-46e1680ea587?w=600&q=75',   span: '' },
      { id: 4, title: 'Castillo San Felipe', desc: 'The great Spanish fortress above the city', url: 'https://images.unsplash.com/photo-1585208798174-6cedd86e019a?w=600&q=75', span: 'md:row-span-2' },
      { id: 5, title: 'Local Cuisine',    desc: 'Colombia\'s rich Caribbean food culture',    url: 'https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?w=600&q=75',   span: '' },
      { id: 6, title: 'Sunset Bay',       desc: 'Golden hour over Cartagena bay',              url: 'https://images.unsplash.com/photo-1504701954957-2010ec3bcec1?w=600&q=75',  span: 'md:col-span-2' },
    ],
  ...
  'buenos-aires': {
    ...
    heroImage:   'https://images.unsplash.com/photo-1589909202802-8f4aadce1849?w=1000&auto=format&fit=crop&q=80',
    ...
    gallery: [
      { id: 1, title: 'La Boca',            desc: 'Buenos Aires\' most colourful neighbourhood',  url: 'https://images.unsplash.com/photo-1589909202802-8f4aadce1849?w=600&q=75',   span: 'md:col-span-2 md:row-span-2' },
      { id: 2, title: 'Obelisco',           desc: 'The iconic heart of Buenos Aires',              url: 'https://images.unsplash.com/photo-1562516710-8bcd8c62b79e?w=600&q=75',      span: '' },
      { id: 3, title: 'Tango',              desc: 'The dance that defines the city',               url: 'https://images.unsplash.com/photo-1545041703-f4bb2e31a9f0?w=600&q=75',      span: '' },
      { id: 4, title: 'Iguazú Falls',       desc: 'One of the world\'s great natural wonders',     url: 'https://images.unsplash.com/photo-1590577976322-3d2d6a2130f5?w=600&q=75',    span: 'md:row-span-2' },
      { id: 5, title: 'Argentine Asado',    desc: 'The sacred ritual of Argentine barbecue',       url: 'https://images.unsplash.com/photo-1558030006-450675393462?w=600&q=75',      span: '' },
      { id: 6, title: 'Recoleta',           desc: 'The grand Parisian boulevards of Recoleta',     url: 'https://images.unsplash.com/photo-1536098561742-ca998e48cbcc?w=600&q=75',   span: 'md:col-span-2' },
    ],
